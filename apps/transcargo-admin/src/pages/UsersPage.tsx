...
const ROLES: User['role'][] = ['SENDER', 'DRIVER', 'ADMIN'];
...
const ROLE_BADGE: Record<User['role'], string> = {
  ...
  SENDER: 'bg-slate-100 text-slate-700',
};
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-brand-600 text-white px-4 py-2 rounded-md text-sm hover:bg-brand-700"
        >
